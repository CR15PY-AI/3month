...
#         #self.text_edit.resize(300,200) # Задает размеры текстовому полю
...
# import sys
# from PyQt6.QtWidgets import QApplication, QWidget, QTextEdit, QLabel, QCheckBox
...
#         if state == 2:
#             self.label.setText("Вы cогласились")
#         else:
#             self.label.setText("Вы не согласились")
#         self.label.adjustSize() #Адаптирует размер текста
