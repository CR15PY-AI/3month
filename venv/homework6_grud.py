...
import sys
import homework6_crud

class UserApp(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("User homework_6 CRUD (PyQt6)")
        self.setGeometry(100, 100, 600, 450)

        homework6_crud.create_table()
    ...
    def add_user(self):
        ...
        try:
            conn = homework6_crud.connect_db()
    ...
    def update_user(self):
        ...
        if ok:
            ...
            count = homework6_crud.update_user(user_id, name, age, email, phone, city)
            if count:
